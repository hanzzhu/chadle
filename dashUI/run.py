...
def pre_process_CL(ProjectName, Runtime, PretrainedModel, ImWidth, ImHeight, ImChannel,
...
def training_CL(DLModelHandle, DLDataset, TrainParam):
    call_list = setup_hdev_engine()
...
def evaluation_CL(ProjectName, Runtime, PretrainedModel, ImWidth, ImHeight, ImChannel,
